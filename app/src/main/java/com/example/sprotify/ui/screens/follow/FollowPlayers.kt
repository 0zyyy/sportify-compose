...
@Composable
fun FollowPlayersPage(){
    Column {
        Header(title = "Follow Your Favourite Players", subtitleText = "Get news,game updates highlights and more info on your favorite teams")
        FollowPlayers()
    }
}
